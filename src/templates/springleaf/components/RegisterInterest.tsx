      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
            {registerInterest.subtitle || 'Leave your details and we\'ll get back to you with personalized information about this exclusive property opportunity.'}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="fullName" className="block text-white text-sm font-medium mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Full Name<span className="text-red-400 ml-1">*</span></span>
                  </div>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-white text-sm font-medium mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Email Address<span className="text-red-400 ml-1">*</span></span>
                  </div>
                </label>
                <input
                  type="email"
            ...
            <div>
              <label htmlFor="mobile" className="block text-white text-sm font-medium mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Mobile Number<span className="text-red-400 ml-1">*</span></span>
                </div>
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="message" className="block text-white text-sm font-medium mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Message <span className="text-gray-400 text-xs">(optional)</span></span>
                </div>
              </label>
              <textarea
                id="message"
            ...
            <div className="pt-4 border-t border-gray-600">
              <p className="text-xs text-gray-400 leading-relaxed">
                By submitting this form, you consent to being contacted by {registerInterest.businessName || 'our team'} 
                regarding this property opportunity. We respect your privacy and will not share your information with third parties.
              </p>
            </div>
          </form>
        </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-sm">
                {registerInterest.contactInfo.email && (
                  <div className="flex items-center space-x-2 text-primary-600">
                    ...
                    <a href={`mailto:${registerInterest.contactInfo.email}`} className="hover:underline">
                      {registerInterest.contactInfo.email}
                    </a>
                  </div>
                )}
                {registerInterest.contactInfo.phone && (
                  <div className="flex items-center space-x-2 text-primary-600">
                    ...
                    <a href={`tel:${registerInterest.contactInfo.phone}`} className="hover:underline">
                      {registerInterest.contactInfo.phone}
                    </a>
                  </div>
                )}
