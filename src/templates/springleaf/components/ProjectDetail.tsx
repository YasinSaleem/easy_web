    ...
    <section className='py-16 bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>{projectDetail.subtitle}</p>
        </div>
        ...
        <div className='space-y-16'>
          ...
          <div className='bg-gradient-to-r from-primary-600 to-primary-700 rounded-3xl p-8 text-center text-white'>
            ...
            <p className='text-primary-100 mb-6 max-w-2xl mx-auto'>
              Schedule a private tour or speak with our sales team to discover everything this
